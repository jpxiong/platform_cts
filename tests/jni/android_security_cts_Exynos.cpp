 ...
 * cts/tests/src/android/security/cts/Exynos.java
 */

jboolean android_security_cts_Exynos_doExynosWriteTest(JNIEnv* env, jobject thiz)
{
...
jboolean android_security_cts_Exynos_doExynosReadTest(JNIEnv* env, jobject thiz)
{
...
static JNINativeMethod gMethods[] = {
    {  "doExynosWriteTest", "()Z",
            (void *) android_security_cts_Exynos_doExynosWriteTest },
    {  "doExynosReadTest", "()Z",
            (void *) android_security_cts_Exynos_doExynosReadTest },
};

int register_android_security_cts_Exynos(JNIEnv* env)
{
    jclass clazz = env->FindClass("android/security/cts/Exynos");
