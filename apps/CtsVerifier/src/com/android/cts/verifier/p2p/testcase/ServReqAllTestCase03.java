 ...
 * WifiP2pDnsSdServiceRequest.newInstance() and
 * WifiP2pUpnpServiceRequest.newInstance().
 */
public class ServReqAllTestCase03 extends ServReqTestCase {

    public ServReqAllTestCase03(Context context) {
        super(context);
    }
    ...
    protected boolean executeTest() throws InterruptedException {
        ...
        reqList.add(WifiP2pDnsSdServiceRequest.newInstance());
        reqList.add(WifiP2pUpnpServiceRequest.newInstance());
    ...
    public String getTestName() {
        return "Request all services test 03";
    }
}
