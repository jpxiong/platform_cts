...
$(cts_prebuilt_jar): $(JUNIT_HOST_JAR) $(HOSTTESTLIB_JAR) $(TF_JAR) $(CTS_TF_JAR) $(CTS_TF_EXEC_PATH) | $(ACP) $(HOST_OUT_EXECUTABLES)/adb
	mkdir -p $(PRIVATE_TESTS_DIR)
	mkdir -p $(PRIVATE_PLANS_DIR)
	mkdir -p $(PRIVATE_TOOLS_DIR)
	$(ACP) -fp $(JUNIT_HOST_JAR) $(HOSTTESTLIB_JAR) $(TF_JAR) $(CTS_TF_JAR) $(CTS_TF_EXEC_PATH) $(PRIVATE_TOOLS_DIR)
